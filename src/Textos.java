...
public class Textos {
    ...
    /////Capítulo 1//////////////////////////////////////
     ...
     ,"Opção 1 - Direita;" ,"Opção 2 - Esquerda" , protagonista1,20, scan) ;
    ...
    "Aceita ir conhecer ou irá seguir para seu quarto?","Opção 1- Você aceita e vê o que terá de tão inovador nesse quarto. ","Opção 2 - Você se nega educadamente e vai em direção ao seu.",protagonista1,-10,scan );
    ...
    "Assim que entra, se deita e percebe que o barulho do quarto 1412, ao lado do seu, parou. Após isso, você se deita e descansa pelo resto da noite."+ "Fim!", null, null, protagonista1, 0, null );
    ...
    "Enquanto você observa o quadro, algo de estranho acontece ao redor... O seu arredor começa a escurecer..." + "De repente você acorda ,aparentemente você desmaiou durante a apreciação do quadro, porém o quarto está estranho...Cores e mobílias diferentes, até mesmo a porta está com uma coloração nova. " +
     ...
     "A chave parecia bem comum, porém igual as chaves dos quartos do hotel. Mas com uma entonação de cor diferente, ela ainda brilhava bastante parecia lhe chamar cada vez mais que você a encarava.","Opção 1 - Pegue a chave","Opção 2 - Reijeite",protagonista1,0,scan);
    ...
    "Opção 1- Pegue o relógio","Opção 2 - Já aconteceram coisas estranhas demais por hoje, deixe-o aí.",protagonista1, -10,scan);
     ...
     " Fim!", null, null, protagonista1, 0, null);
     ...
     " Continua no próximo capítulo!",null,null,protagonista1,-10,null);
    ...
    if( escolhainicio == 1){
        ...
        if (escolhacapitulo1 == 1) {
            ...
            if (escolhacapitulo13 == 1) {
                capitulo14.mostrar();
                int escolhacapitulo14 = capitulo14.escolher();
                if (escolhacapitulo14 == 1) {
                    capitulo16.mostrar();

                    
                }
                else if (escolhacapitulo14 == 2) {
                    capitulo17.mostrar();
